...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6000179625:AAHsXcF7OvCPP6zNLjQvxino7jJ6qdpTY6c"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Chat gpt Vineet'
username = 'chatgptvineet_bot'
